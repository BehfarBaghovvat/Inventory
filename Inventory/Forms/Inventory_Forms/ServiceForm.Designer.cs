...
namespace Inventory_Forms
{
	partial class ServiceForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.controlsPanel.Controls.Add(this.licensePlateTextBox);
			...
			this.currerntKilometerTextBox.Location = new System.Drawing.Point(235, 110);
			...
			this.currerntKilometerTextBox.OnActiveState = stateProperties61;
			...
			this.currerntKilometerTextBox.OnDisabledState = stateProperties62;
			...
			this.currerntKilometerTextBox.OnHoverState = stateProperties63;
			stateProperties64.BorderColor = System.Drawing.Color.LimeGreen;
			...
			this.currerntKilometerTextBox.OnIdleState = stateProperties64;
			...
			this.serviceNameComboBox.Location = new System.Drawing.Point(712, 63);
			...
			stateProperties65.BorderColor = System.Drawing.Color.Fuchsia;
			...
			this.posPaymentTextBox.OnActiveState = stateProperties65;
			stateProperties66.BorderColor = System.Drawing.Color.FromArgb(((int)(((byte)(26)))), ((int)(((byte)(0)))), ((int)(((byte)(61)))));
			...
			this.posPaymentTextBox.OnDisabledState = stateProperties66;
			stateProperties67.BorderColor = System.Drawing.Color.Cyan;
			...
			this.posPaymentTextBox.OnHoverState = stateProperties67;
			...
			this.posPaymentTextBox.OnIdleState = stateProperties68;
			...
			this.cashPaymentTextBox.OnActiveState = stateProperties69;
			stateProperties70.BorderColor = System.Drawing.Color.FromArgb(((int)(((byte)(26)))), ((int)(((byte)(0)))), ((int)(((byte)(61)))));
			...
			this.cashPaymentTextBox.OnDisabledState = stateProperties70;
			...
			this.cashPaymentTextBox.OnHoverState = stateProperties71;
			stateProperties72.BorderColor = System.Drawing.Color.DimGray;
			...
			this.cashPaymentTextBox.OnIdleState = stateProperties72;
			...
			this.serviceNumberTextBox.Location = new System.Drawing.Point(380, 59);
			...
			this.serviceNumberTextBox.OnActiveState = stateProperties73;
			...
			this.serviceNumberTextBox.OnDisabledState = stateProperties74;
			...
			this.serviceNumberTextBox.OnHoverState = stateProperties75;
			...
			this.serviceNumberTextBox.OnIdleState = stateProperties76;
			...
			this.descriptionTextBox.Location = new System.Drawing.Point(451, 110);
			...
			this.descriptionTextBox.OnActiveState = stateProperties77;
			...
			this.descriptionTextBox.OnDisabledState = stateProperties78;
			...
			this.descriptionTextBox.OnHoverState = stateProperties79;
			...
			this.descriptionTextBox.OnIdleState = stateProperties80;
			...
			this.repairmanNameTextBox.Location = new System.Drawing.Point(164, 59);
			...
			this.repairmanNameTextBox.OnActiveState = stateProperties81;
			...
			this.repairmanNameTextBox.OnDisabledState = stateProperties82;
			...
			this.repairmanNameTextBox.OnHoverState = stateProperties83;
			...
			this.repairmanNameTextBox.OnIdleState = stateProperties84;
			...
			this.clientNameTextBox.Location = new System.Drawing.Point(258, 12);
			...
			this.clientNameTextBox.OnActiveState = stateProperties89;
			...
			this.clientNameTextBox.OnDisabledState = stateProperties90;
			...
			this.clientNameTextBox.OnHoverState = stateProperties91;
			...
			this.clientNameTextBox.OnIdleState = stateProperties92;
			...
			this.servicePriceTextBox.Location = new System.Drawing.Point(496, 59);
			...
			this.servicePriceTextBox.OnActiveState = stateProperties93;
			...
			this.servicePriceTextBox.OnDisabledState = stateProperties94;
			stateProperties95.BorderColor = System.Drawing.Color.Empty;
			...
			this.servicePriceTextBox.OnHoverState = stateProperties95;
			...
			this.servicePriceTextBox.OnIdleState = stateProperties96;
			...
			this.inventorySerialNumberTextBox.Location = new System.Drawing.Point(477, 12);
			...
			this.inventorySerialNumberTextBox.OnActiveState = stateProperties97;
			...
			this.inventorySerialNumberTextBox.OnDisabledState = stateProperties98;
			stateProperties99.BorderColor = System.Drawing.Color.Empty;
			...
			this.inventorySerialNumberTextBox.OnHoverState = stateProperties99;
			stateProperties100.BorderColor = System.Drawing.Color.Maroon;
			...
			this.inventorySerialNumberTextBox.OnIdleState = stateProperties100;
			...
			this.serviceDateTextBox.Location = new System.Drawing.Point(909, 12);
			...
			this.serviceDateTextBox.OnActiveState = stateProperties101;
			...
			this.serviceDateTextBox.OnDisabledState = stateProperties102;
			...
			this.serviceDateTextBox.OnHoverState = stateProperties103;
			stateProperties104.BorderColor = System.Drawing.Color.Maroon;
			...
			this.serviceDateTextBox.OnIdleState = stateProperties104;
			...
			this.serviceTimeTextBox.Location = new System.Drawing.Point(693, 12);
			...
			this.serviceTimeTextBox.OnActiveState = stateProperties53;
			...
			this.serviceTimeTextBox.OnDisabledState = stateProperties54;
			...
			this.serviceTimeTextBox.OnHoverState = stateProperties55;
			...
			this.serviceTimeTextBox.OnIdleState = stateProperties56;
			...
			this.licensePlateTextBox.BorderColorActive = System.Drawing.Color.Fuchsia;
			this.licensePlateTextBox.BorderColorDisabled = System.Drawing.Color.FromArgb(((int)(((byte)(161)))), ((int)(((byte)(161)))), ((int)(((byte)(161)))));
			this.licensePlateTextBox.BorderColorHover = System.Drawing.Color.Cyan;
			this.licensePlateTextBox.BorderColorIdle = System.Drawing.Color.DimGray;
			...
			this.licensePlateTextBox.DefaultFont = new System.Drawing.Font("IRANSansXFaNum", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(178)));
			...
			this.licensePlateTextBox.Location = new System.Drawing.Point(42, 12);
			this.licensePlateTextBox.MaximumSize = new System.Drawing.Size(200, 35);
			this.licensePlateTextBox.MaxLength = 32767;
			this.licensePlateTextBox.MinimumSize = new System.Drawing.Size(100, 35);
			...
			this.licensePlateTextBox.OnActiveState = stateProperties85;
			...
			this.licensePlateTextBox.OnDisabledState = stateProperties86;
			...
			this.licensePlateTextBox.OnHoverState = stateProperties87;
			...
			this.nextKilometerTextBox.Location = new System.Drawing.Point(19, 110);
			...
			stateProperties57.BorderColor = System.Drawing.Color.Fuchsia;
			...
			this.nextKilometerTextBox.OnActiveState = stateProperties57;
			...
			this.nextKilometerTextBox.OnDisabledState = stateProperties58;
			stateProperties59.BorderColor = System.Drawing.Color.Cyan;
			...
			this.nextKilometerTextBox.OnHoverState = stateProperties59;
			stateProperties60.BorderColor = System.Drawing.Color.OrangeRed;
			...
			this.nextKilometerTextBox.OnIdleState = stateProperties60;
