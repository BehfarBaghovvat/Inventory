...
namespace Mbb.Windows.Forms
{
	...
	public class MBBComboBox : UserControl
	{
		//Field
		...
		public MBBComboBox()
		{
			...
			cmbList.TextChanged += new EventHandler(ComboBox_TextChanged);//Draw icon
			...
			btnIcon.Click += new EventHandler(Icon_Click); //Opent dropdown list
